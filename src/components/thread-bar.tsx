...
export const ThreadBar = ({ count, image, timestamp, name = "Member", onClick }: ThreadBarProps) => {
    ...
    return (
        <button
            onClick={onClick}
            className="p-1 rounded-md hover:bg-white border border-transparent hover:border-border flex items-center justify-start group/thread-bar transition max-w-[300px]"
        >
