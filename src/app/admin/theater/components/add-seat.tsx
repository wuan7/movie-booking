...
import { useRows, useRowsLoading } from "@/features/seats/store/use-seats";
import { Button } from "@/components/ui/button";
import { SeatLayout } from "./seat-layout";
import { useCreateSeat } from "@/features/seats/api/use-create-seat";
...
export const AddSeat = () => {
  ...
  const [type, setType] = useState<"standard" | "vip" | "couple" | "empty">(
    "standard"
  );
  ...
  const { data: rows, isLoading: rowsLoading } = useGetRows({
    ...
    <div>
      ...
      <div className="w-full space-y-2">
        ...
        <div>
          {rows && (
            <Select
              onValueChange={(value: Id<"rows">) => setSelectedRowId(value)}
              required
              disabled={isPending}
            >
              <SelectTrigger className="md:w-[380px] w-full">
          ...
          >
            ...
            <SelectContent>
              <SelectGroup>
                ...
                <SelectItem value="first-left-row">first-left-row</SelectItem>
                <SelectItem value="first-right-row">first-right-row</SelectItem>
                <SelectItem value="first-row">first-row</SelectItem>
                <SelectItem value="middle-left-row">middle-left-row</SelectItem>
                <SelectItem value="middle-row">middle-row</SelectItem>
                <SelectItem value="middle-right-row">
                  middle-right-row
                </SelectItem>
                <SelectItem value="last-left-row">last-left-row</SelectItem>
                <SelectItem value="last-row">last-row</SelectItem>
                <SelectItem value="last-right-row">last-right-row</SelectItem>
              </SelectGroup>
            </SelectContent>
          </Select>
          <Input
