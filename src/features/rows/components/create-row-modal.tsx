...
export const CreateRowModal = () => {
  const [open, setOpen] = useCreateRowModal();
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="overflow-y-auto max-h-[80vh] p-6">
        <DialogHeader>
          <DialogTitle>Add a seat row</DialogTitle>
        </DialogHeader>
        <div>
          <Select
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="w-full">
            ...
            <div key={row._id} className="w-full flex">
              <div className="w-6 bg-blue-500 flex items-center justify-center p-1">{row.rowNumber}</div>
              <div className="flex-1 bg-green-500 flex items-center  p-1">{row.rowName}</div>
            </div>
